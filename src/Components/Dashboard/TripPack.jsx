...
const TripPack = ({ placeName, shortDesc, Date }) => {
  return (
    <div className='p-2 py-5 pr-5 max-w-xs w-80 flex gap-1 flex-col hover:scale-105 transition-transform bg-orange-300 bg-opacity-60  backdrop-blur-lgbg-opacity-60 backdrop-filter backdrop-blur-lg '>
