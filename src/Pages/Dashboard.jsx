...
const Dashboard = () => {
  return (
    <div className='min-h-screen flex flex-row w-full relative'>
      <Bg />
      <div className='flex flex-col gap-5 justify-between bg-primary-lightDash bg-opacity-60 backdrop-filter backdrop-blur-lg'>
        <h1 className='text-lg text-gray-600 pl-5'>Dashboard</h1>
